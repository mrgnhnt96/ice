...
@JsonSerializable(constructor: r'_$fromJson',)
abstract class _$Example extends State{
const _$Example() : super();

const factory _$Example._$fromJson(String name)
= Example;
factory _$Example.fromJson(Map<String, dynamic> json) => _$$ExampleFromJson(json);
...
const factory _$Other._$fromJson(String name)
= Other;
...
const factory _$Error._$fromJson()
= Error;
...
@JsonSerializable(constructor: r'_$fromJson',)
abstract class _$State with EquatableMixin, _$StateMixin implements _$StateUnion{
const _$State();


const factory _$State._$fromJson()
= State;
...
switch (runtimeType){
case _$Example:
return example(this as _$Example);case _$Other:
return other(this as _$Other);case _$Error:
return error(this as _$Error);default:
throw UnsupportedError('Unsupported type: $this');
}}
R when<R extends Object?> ({
required R Function(String name,) example,
required R Function(String name,) other,
required R Function() error,}) {
return map(
example: (u) => example(u.name,),
other: (u) => other(u.name,),
error: (u) => error(),
);}
...
R Function(String name,)? example,
R Function(String name,)? other,
R Function()? error,
required _$NoStateCallback<R> orElse,}) {
return map(
example: (u) => example?.call(u.name,) ?? orElse(),
other: (u) => other?.call(u.name,) ?? orElse(),
...
R Function()? error,}) {
return map(
example: (u) => example?.call(u.name,),
other: (u) => other?.call(u.name,),
error: (u) => error?.call(),
);}
bool get isExample => this is _$Example;
bool get isOther => this is _$Other;
bool get isError => this is _$Error;Map<String, dynamic> toJson({bool includeUnionType = true}){
switch(runtimeType){
case Example:
